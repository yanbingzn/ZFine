...
namespace ZFine.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "ZFine_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("ZFine_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("ZFine_licence", Licence.GetLicence());
        }
